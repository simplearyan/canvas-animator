        ...
        <header class="site-header">
            ...
            <div class="logo">ANIMATOR<span>STUDIO</span></div>
                    <nav style="display: flex; gap: 1rem;">
                        ...
                        <a href="animations/index.html" style="text-decoration: none; color: var(--border); font-weight: 700; border: 1px solid var(--border); padding: 5px 10px; font-size: 0.8rem; text-transform: uppercase;">Independent Animators</a>
                    </nav>
                </div>
